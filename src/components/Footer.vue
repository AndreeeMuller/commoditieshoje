        ...
        <q-card>
          <q-card-section>
            ...
            <p class="text-subtitle2">
              Fonte: <q-btn type="a" href="https://blog.toroinvestimentos.com.br/commodities-o-que-sao" target="_blank" color="primary">Toro Investimentos (Commodities - o que são commodities?)</q-btn>
            </p>
          </q-card-section>
        </q-card>
      </div>
